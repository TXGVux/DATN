...
# Crawl 20 trang
for page in range(1, 936):
    print(f"📄 Đang xử lý trang {page}...")

    url = f"https://batdongsan.com.vn/ban-nha-rieng-tp-hcm/p{page}"
...
df.columns.name = "Thông tin nhà đất"
df.to_excel("nha_dat_batdongsan_20_trang.xlsx", index=False)

print("✅ Đã crawl xong 20 trang và lưu vào file Excel.")
