...
for page in range(1, 705):
    ...
    url = f"https://batdongsan.com.vn/ban-can-ho-chung-cu-ha-noi/p{page}"
...
df.columns.name = "Thông tin Chung cư"
df.to_excel("Chung_Cu_batdongsan_Hà_NộiNội.xlsx", index=False)

print("✅ Đã crawl xong trang và lưu vào file Excel.")
